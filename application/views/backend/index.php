  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Dashboard') ; ?>">
        ...
        <div class="sidebar-brand-text mx-3">ANGGREK CANTIK</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="monitoring" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('Dashboard/rekap') ; ?>">Data Rekap</a>
            <a class="collapse-item" href="<?= base_url('Dashboard/grafik') ; ?>"">Data Grafik</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Anggrek cantik <?= date('Y') ; ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
